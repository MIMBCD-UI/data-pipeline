...
def anonymize_dicom_file(input_path, output_path, anon_patient_id, modality, date, sequence, instance):
    """
    ...
    try:
        ...
        new_filename = f"{anon_patient_id}_{modality}_{date}_{sequence}_{instance}.dcm"
